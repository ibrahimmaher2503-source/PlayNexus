...
@section('content')
    <main class="mx-auto min-h-screen max-w-6xl px-4 py-6 sm:px-6">
        ...
        <form class="mt-8 space-y-8" method="POST" action="{{ route('branches.settings.update', $branch) }}">
            @csrf
            @method('PATCH')
            <input type="hidden" name="expected_lock_version" value="{{ $branch->lock_version }}">

            <section class="rounded-[14px] border border-[var(--pn-border)] bg-[var(--pn-surface)] p-5" aria-labelledby="identity-heading">
            ...
            <section class="rounded-[14px] border border-[var(--pn-border)] bg-[var(--pn-surface)] p-5" aria-labelledby="operations-heading">
            ...
            <section class="rounded-[14px] border border-[var(--pn-border)] bg-[var(--pn-surface)] p-5" aria-labelledby="hours-heading">
                            ...
                            @foreach ($openingHours as $day)
                                ...
                                <tr>
                                    ...
                                    <td class="px-3 py-3">
                                        ...
                                        <select class="min-h-11 rounded-[10px] border border-[var(--pn-border)] bg-[var(--pn-surface)] px-3 focus:outline-none focus:ring-2 focus:ring-[var(--pn-focus)]" id="day-{{ $weekday }}-closed" name="opening_hours[{{ $rowIndex }}][is_closed]" required>
                                    ...
                                    <td class="px-3 py-3">
                                        ...
                                        <input class="min-h-11 rounded-[10px] border border-[var(--pn-border)] bg-[var(--pn-surface)] px-3 tabular-nums focus:outline-none focus:ring-2 focus:ring-[var(--pn-focus)]" id="day-{{ $weekday }}-opens" name="opening_hours[{{ $rowIndex }}][opens_at]" type="time" value="{{ $opensAt }}" step="60">
                                    ...
                                    <td class="px-3 py-3">
                                        ...
                                        <input class="min-h-11 rounded-[10px] border border-[var(--pn-border)] bg-[var(--pn-surface)] px-3 tabular-nums focus:outline-none focus:ring-2 focus:ring-[var(--pn-focus)]" id="day-{{ $weekday }}-closes" name="opening_hours[{{ $rowIndex }}][closes_at]" type="time" value="{{ $closesAt }}" step="60">
